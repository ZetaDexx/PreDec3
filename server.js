  ...
  try {
    ...
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: "user",
          content: `Проанализируй судебное решение и предоставь JSON-ответ строго в следующем формате:
          {
            ...
            "keyPoints": ["Перечень ключевых моментов для апелляции (не менее трех пунктов)"],
            ...
            "schema": {
              ...
              "properties": {
                ...
                "keyPoints": {
                  ...
                  "description": "Ключевые моменты для апелляции"
                },
                "recommendations": {
                  "type": "string",
                  "description": "Рекомендации по дальнейшим действиям"
                }
              },
